...
- [RA.Aid](https://github.com/ai-christianson/ra-aid): An AI-driven command-line tool that combines aider with LangChain ReAct agents for research, planning, and implementation of development tasks. ![GitHub Repo stars](https://img.shields.io/github/stars/ai-christianson/RA.Aid?style=social)
